...
public class RootCintroller implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		pieList.add(new PieChart.Data("Java",70));
		pieList.add(new PieChart.Data("HTML",50));
		...
		data3.add(new XYChart.Data<String, Integer>("임성원", 50));
		data3.add(new XYChart.Data<String, Integer>("정준영", 60));
